...
This document is the master index of the feature epics that shaped the system — a history
of what was built, not a live task tracker. Epics 1–18 are climate-control features; Epics
19–20 covered the (since-abandoned) Vesta open-source extraction. The reasoning behind
individual decisions lives in the ADRs under `docs/adr/`.
