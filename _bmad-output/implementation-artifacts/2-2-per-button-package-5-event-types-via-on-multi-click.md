...
- [ ] Task 1: Implement and verify all 5 `on_multi_click` patterns in `firmware/common/button.yaml` (AC: 1, 2)
- [ ] Task 2: Wire frame construction to `canbus_protocol.h` helpers only (AC: 3, 4)
- [ ] Task 3: Confirm package parameterization remains reusable across buttons and nodes (AC: 5)
- [ ] Task 4: Run compile gates for node100 and node101 (AC: 6, 7)
